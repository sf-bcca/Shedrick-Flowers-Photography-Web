...
const ContactPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!accessKey) {
        console.error(
          "CRITICAL: Missing VITE_WEB3FORMS_ACCESS_KEY in environment variables."
        );
        throw new Error(
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-24">
        <div className="mb-12 text-center lg:mb-20 lg:text-left">
          ...
          <p className="mt-6 max-w-2xl text-xl font-normal text-slate-500 dark:text-[#93a5c8] lg:mx-0 animate-fade-in-up delay-100">
            Interested in a session? I'd love to hear your story. Fill out the
            form below or reach out directly to discuss your vision.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-20">
          ...
          <div className="lg:col-span-7 animate-fade-in-up delay-200">
            {submitStatus === "success" ? (
              <div
                className="rounded-3xl bg-white dark:bg-[#1a2232] p-8 shadow-2xl ring-1 ring-slate-900/5 dark:ring-white/5 sm:p-12 text-center"
                role="status"
                aria-live="polite"
              >
                ...
                <p className="text-lg text-slate-600 dark:text-[#93a5c8] mb-8">
                  ...
                  possible to discuss your vision.
                </p>
                <button
              ...
              <form
                className="space-y-8 rounded-3xl bg-white dark:bg-[#1a2232] p-8 shadow-2xl ring-1 ring-slate-900/5 dark:ring-white/5 sm:p-12"
              ...
              >
                ...
                <label className="block group">
                  <span className="mb-3 flex items-center justify-between text-sm font-bold text-slate-700 dark:text-slate-200 uppercase tracking-wide">
                    <span>Your Vision</span>
                    <span
                      className="text-xs font-normal normal-case text-slate-400"
                      aria-live="polite"
                    >
                  ...
                  >
                    {submitStatus === "submitting" ? (
                      ...
                      <>
                        ...
                        <span
                          className="material-symbols-outlined transition-transform group-hover:translate-x-1 text-xl"
                          aria-hidden="true"
                        >
                          send
                        </span>
            ...
            <div className="flex flex-col gap-8 sticky top-24">
              ...
              <div className="rounded-3xl bg-slate-100 dark:bg-[#1a2232] p-8 lg:p-10 border border-transparent dark:border-white/5 shadow-xl">
                ...
                <div className="space-y-8">
                  <a
                    className="flex items-start gap-6 transition-all hover:translate-x-2 group"
                    href={`mailto:${email}`}
                  >
                    ...
                    <div>
                      <p className="text-sm font-bold text-slate-500 dark:text-[#93a5c8] uppercase tracking-wide mb-1">
                        Email
                      </p>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-slate-900 dark:text-white group-hover:text-primary transition-colors leading-snug">
                        {phone}
                      </p>
                    </div>
                  </a>
